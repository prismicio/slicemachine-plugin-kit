...
# Clone your fork
git clone git@github.com:<your-username>/slicemachine-plugin-kit.git
...
## `@slicemachine/plugin-kit` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/slicemachine-plugin-kit/issues/new/choose
